...
public class SimpleITest extends TestNGEngineMethodDL {
    ...
    public Goate[] dlp() {
        Goate[] d = new Goate[2];
        d[0] = new Goate()
                .put("dl##", new StaticDL().add("status", true).add("Scenario", "first pass"))
                .put("dl##", new StaticDL().add("status", false).add("Scenario", "second pass"))
                .put("dl##", new StaticDL().add("status", true).add("Scenario", "third pass"));
        return d;
    }
